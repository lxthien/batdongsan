<?php
class fnews extends MY_Controller{
    ...
    function index($offset = 0, $limit = 15)
    {
        ...
        $dis['newNews'] = $newNews;
        setPaginationVb('tin-tuc/', $newNews->paged->total_rows, $limit, 2);
    ...
    function cat($cat = NULL, $offset = 0, $limit = 15 ){
        ...
        $dis['news'] = $cat_news;
        setPaginationVb('tin-tuc/'.$cat,$cat_news->paged->total_rows,$limit,3);
	...
	function detail($title_none = NULL){
        ...
        $related_news->get_paged(0, 9, TRUE);
