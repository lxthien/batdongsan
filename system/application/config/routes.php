...
$route['fuser/deletePhotoDefault/(:num)']   = "fuser/deletePhotoDefault/$1";
$route['fuser/deletePhoto/(:num)/(:num)']   = "fuser/deletePhoto/$1/$2";
$route['fuser/getRoot']                     = "fuser/getRoot";

//router for page single
$route['gioi-thieu.html']                   = "home/pagesigle/$1";
$route['quy-che-hoat-dong.html']            = "home/pagesigle/$1";
...
$route['doanh-nghiep/(:any)/(:num)']        = "fcompany/cat/$3";
...
$route['tin-tuc/(:any)/(:any)']             = "fnews/detail/$4";
$route['tin-tuc/(:num)']                    = "fnews/index/$2";
$route['tin-tuc/(:any)']                    = "fnews/cat/$1";

// router for cam nang
$route['cam-nang']                          = "fguides";
$route['cam-nang/(:any)/(:num)']            = "fguides/cat/$3";
$route['cam-nang/(:any)/(:any)']            = "fguides/detail/$4";
$route['cam-nang/(:num)']                   = "fguides/index/$2";
...
$route['can-mua-nha-dat/(:any)/(:any)/(:num)']                 = "festates/getEstateByTypeDistrict";
...
$route['can-thue-nha-dat/(:any)/(:any)/(:num)'] 	           = "festates/getEstateByTypeDistrict";
...
$route['can-mua-nha-dat/(:any)/(:num)']                 = "festates/estateByTypeCity";
...
$route['can-thue-nha-dat/(:any)/(:num)']                       = "festates/estateByTypeCity";
...
$route['can-mua-nha-dat/(:any)/(:any)']                 = "festates/getEstateByTypeDistrict";
...
$route['can-thue-nha-dat/(:any)/(:any)']                = "festates/getEstateByTypeDistrict";
...
$route['can-mua-nha-dat/(:any)']                        = "festates/estateByTypeCity";
...
$route['can-thue-nha-dat/(:any)']                       = "festates/estateByTypeCity";
