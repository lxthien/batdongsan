...
<div class="linktop" style="width:600px;height:20px; float:left; margin-top:8px; margin-left: 0px; margin-bottom:10px;">
    <div class="linkdautrang" style="margin-left:10px; width:auto; float:left;"><a href="<?=$base_url?>">Trang chủ</a></div>
    <div class="linkdautrang" style=" width:auto; float:left;"><a class="linkdautrang-active" href="<?=$base_url.'huong-dan-dang-tin'?>.html" title="Hướng dẫn đăng tin">Hướng dẫn đăng tin</a></div>
</div>
        ...
        <div class="hotnew">
            <div class="sreentieudethitruong" style="width: 640px;">
                <div class="tieudethitruongchitiet">
                    <h1 style="font-size: 25px; color:#051c94;">Hướng dẫn đăng tin</h1>
                </div>
            </div>
            <div id="postGuide" class="noidunggioithieu" style="width:640px; margin-top:25px; margin-left: 0px; margin-bottom:10px; line-height: 23px;">
