    ...
    $('#frm-post').validate({
        ...
        messages:{
            ...
            captcha_code:{
                ...
                maxlength: 'Mã xác nhận 4 ký tự',
                minlength: 'Mã xác nhận 4 ký tự'
            },
            area_text:{
...
<div class="linktop" style="width:960px;height:20px; float:left; margin-top:12px; margin-bottom:0px;">
    ...
    <div class="linkdautrang" style=" width:auto; float:left;"><a class="linkdautrang-active" href="<?=$base_url;?>dang-tin">Đăng tin mua bán / cho thuê</a></div>
</div>
...
<div style="width:920px; float:left; border:1px solid #CCCCCC; height:auto; border-top:none; margin-bottom:15px; margin-left:9px; padding: 20px;">
    <div class="righttv" style="width:920px;margin-bottom:-16px;float:left;margin-left:0px;">
        <div style="width: 920px; margin: 0 auto;">
            ...
            <p style="text-align:center;color:#0000;margin-top:0px;font-size: 14px; line-height: 20px;">
                Để nổi bật hơn với khách truy cập, bạn cần chú ý cả phần hình thức và nội dung. </br>
                Đừng để tin rao của bạn đánh mất ấn tượng từ cái nhìn đầu tiên. </br>
				<strong>Bạn nên lưu ý: Nếu là dự án, bạn chỉ được đăng tối đa 3 tin/dự án. </br>
				Nếu nội dung này bạn đã đăng rồi, bạn sẽ bị xóa tin ngay!</strong>
            </p> </br>
            <div class="register login post">
                ...
                <div class="main-register">
                    <form class="form-register" id="frm-post" name="frmContact" method="post" action="<?= $base_url; ?>dang-tin"
                                            ...
                                            <span class="rowInput">
                                                <select name="estatecatalogue_id" id="estatecatalogue_id">
                                                    ...
                                                    <?php foreach ($this->estateCatalogues as $row): ?>
                                                        <option <?php if ($o->estatecatalogue_id == $row->id) echo 'selected="selected"'; ?>
                        ...
                        <div class="row-post">
                                        <span class="rowInput">
                                            <label><input <?php if ($o->isArea == 0) echo 'checked="checked"'; ?> name="IsArea"
                                                                                                                  value="0"
                                                                                                                  type="radio"/> Có
                                                diện tích</label>
                                            <label><input <?php if ($o->isArea == 1) echo 'checked="checked"'; ?> name="IsArea"
                                                                                                                  type="radio"
                                                                                                                  value="1"/> Không
                                                xác định</label>
                                        </span>
                        ...
                        <div class="row-post">
                            <div class="area-post">
                                <span class="rowLabel">Diện tích: <span style="display: inline-block; color: red;">(*)</span><span
                                        class="note-area-text">(Chỉ dùng số và dấu phẩy)</span></span>
                                            <span class="rowInput">
                                                <input style="width: 443px;" type="text" name="area_text" id="area_text"
                                                       value="<?= $o->area_text; ?>"/>
                                                <span style="position: absolute; right: 6px; top: 2px;">m <sup>2</sup></span>
                                            </span>
                            </div>
                            <div class="area-post-02">
                                <span class="rowLabel">Chọn Mức diện tích: <span
                                            ...
                                            <span class="rowInput">
                                                <select name="estatearea_id" id="estatearea_id">
                                                    ...
                                                    <?php foreach ($this->estateareas as $row): ?>
                                                        <option <?php if ($o->estatearea_id == $row->id) echo 'selected="selected"'; ?>
                        ...
                        <div class="row-post">
                            <div class="area-post phaply">
                                <span class="rowLabel">Pháp lý:</span>
                                            <span class="rowInput">
                                                <select class="select" name="legally" id="legally">
                                                    <option <?php if ($o->legally == '') echo 'selected="selected"'; ?> value="">
                                                        Chọn loại
                                                    </option>
                                                    <option <?php if ($o->legally == 'Bìa hồng') echo 'selected="selected"'; ?>
                                                        value="Bìa hồng">Bìa hồng
                                                    </option>
                                                    <option <?php if ($o->legally == 'Bìa đỏ') echo 'selected="selected"'; ?>
                                                        value="Bìa đỏ">Bìa đỏ
                                                    </option>
                                                    <option <?php if ($o->legally == 'Hợp đồng góp vốn') echo 'selected="selected"'; ?>
                                                        value="Hợp đồng góp vốn">Hợp đồng góp vốn
                                                    </option>
                                                    <option <?php if ($o->legally == 'Hợp đồng') echo 'selected="selected"'; ?>
                                                        value="Hợp đồng">Hợp đồng
                                                    </option>
                                                </select>
                                            </span>
                            </div>
                            <div class="area-post-02">
                                <span class="rowLabel">Hướng:</span>
                                            <span class="rowInput">
                                                <select name="estatedirection_id" id="estatedirection_id">
                                                    <option value="">Chọn Hướng nhà</option>
                                                    <?php foreach ($this->estateDirection as $row): ?>
                                                        <option <?php if ($o->estatedirection_id == $row->id) echo 'selected="selected"'; ?>
                                                            value="<?= $row->id ?>"><?= $row->name ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </span>
                        ...
                        <div class="row-post">
                                        <span class="rowInput">
                                            <label><input <?php if ($o->isPrice == 0) echo 'checked="checked"'; ?> class="isprice"
                                                                                                                   name="IsPrice"
                                                                                                                   type="radio"
                                                                                                                   value="0"/> Có
                                                giá</label>
                                            <label><input <?php if ($o->isPrice == 1) echo 'checked="checked"'; ?> class="isprice"
                                                                                                                   name="IsPrice"
                                                                                                                   type="radio"
                                                                                                                   value="1"/> Thỏa
                                                thuận</label>
                        ...
                        <div class="row-post depend-isprice">
                            ...
                            <div class="select-price">
                                <span class="rowLabel">Chọn Mức giá: <span
                                        style="display: inline-block; color: red;">(*)</span></span>
                                            <span class="rowInput">
                        ...
                        <div class="row-post">
                            <div class="area-post">
                                <span class="rowLabel">Tỉnh/Thành phố: <span
                                        style="display: inline-block; color: red;">(*)</span></span>
                                            <span class="rowInput">
                                                <select name="estatecity_id" id="estatecity_id">
                                                    <option value="">Chọn Tỉnh/Thành phố</option>
                                                    <?php foreach ($this->estateProvince as $row): ?>
                                                        <option <?php if ($o->estatecity_id == $row->id) echo 'selected="selected"'; ?>
                                                            value="<?= $row->id ?>"><?= $row->name; ?></option>
                                                    <?php endforeach;
                                                    unset($row); ?>
                                                </select>
                            ...
                            <div class="area-post-02">
                                <span class="rowLabel">Quận/Huyện: <span
                                        style="display: inline-block; color: red;">(*)</span></span>
                                            <span class="rowInput">
                                                <input type="hidden" name="estatedistrict_selected"
                                                       value="<?= $o->estatedistrict_id ?>"/>
                        ...
                        <div class="row-post">
                            ...
                            <div class="area-post-02" style="padding-top: 3px;">
                                ...
                                <span class="rowInput"><input style="width: 443px;" type="text" name="address" id="address"
                                                              value="<?= $o->address; ?>"/></span>
                            </div>
                        </div>
                        ...
                        <span style="color: #5a5a5a; font-size: 12px; line-height: 16px" class="rowLabel">Tin rao có ảnh sẽ được xem nhiều gấp 10 lần và nhiều người gọi gấp 5 lần so với tin rao không có ảnh. </br>
						Lưu ý: Hình ảnh không vượt quá 1500 px mỗi chiều và dung lượng nhỏ hơn 2 MB.</span>
                        <span> </span>
                        ...
                        <span class="rowLabel">Thuộc Dự án bất động sản:</span>
                                    <span class="rowInput">
                    ...
                    <span style="color: #0000; line-height:20px; font-size: 14px;" class="rowLabel">Nếu gặp khó khăn hoặc cần hỗ trợ trong việc đăng tin, Quý khách hãy liên hệ ngay với Chúng tôi theo số Hotline: 0168 200 0080 hoặc Email: hotro@sotaynhadat.vn để được trợ giúp nhanh chóng!</span>
                    </form>
                </div>
                    </div>
        </div>
