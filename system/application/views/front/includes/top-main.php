<script type="text/javascript" src="<?= $base_url?>images/js/jquery.vticker-min.js"></script>
...
<div class="top-main">
                ...
                <ul>
                    ...
                    <li>
                        <div class="img-news-home"><a href="<?=$base_url.$catParent->name_none.'/'.$cat->name_none.'/'.$row->title_none?>.html">
                                <img alt="<?=$row->title_vietnamese;?>" src="<?php echo image('img/news/'.$row->image, 'news_264_164') ?>" />
								  </a>
                        </div>
                        <div class="info-news-home">
                           ...
                           <a style="font-size:11px; color:#cb0021; line-height:22px; font-style:italic;"> <span class="date-news-home">Cập nhật: <?php echo get_date_from_sql($row->created);  ?></span> </a>
						   <p class="short-news-home"> <a style="line-height:18px; color:#333333;">
                                    <?=strlen($row->short_vietnamese) < 200 ? $row->short_vietnamese : cut_string($row->short_vietnamese, 230).'...';?>
                                </a> 
								</p>
                        </div>
                    </li>
    ...
    <div class="search-home">
            ...
            <form action="<?=$base_url?>tim-kiem-bat-dong-san" method="post">
                <div class="sreenboxseach">
                    <div class="boxseach" style=" width:100px;  float:left; margin-top:5px;">
                        ...
                        <p style="font-weight:bold; font-size:14px; color:#109502; float:left; margin-top:8px; margin-left:5px;"> Rao Bán </p>
                    </div>
                    <div class="boxseach" style=" width:100px;  float:left; margin-top:5px;">
		...
		<div class="link-post-free"><a href="<?php echo $base_url.'dang-tin-rao-vat-nha-dat-mien-phi' ?>">Đăng tin Mua bán/Cho thuê miễn phí</a></div>
    </div>
</div>
<div class="cl"></div>