...
<div class="linktop">
	...
	<div class="linkdautrang"><a href="<?=$base_url.$estatesCategoryUrl?>" title="<?php echo $city->name;?>"><?php echo $city->name;?></a></div>
    <div class="linkdautrang"><a class="linkdautrang-active" href="javascript:void(0)" title="<?=$district->name;?>"><?=$district->name;?></a></div>
</div>
    ...
    <div class="left estates">
        <div class="hotnew">
            <div class="titlenew-add">
                <h1><?php echo $category->name.' tại '.$district->name; ?></h1>
            </div>
            <div class="boxnew">
