...
<div class="grid_15" id="textcontent">
    <form id="form" class="table_input" action="<?=$base_url;?>admin/estates/editFree/<?=$object->id;?>" method="post" enctype="multipart/form-data">
    <table class="table_input">
        ...
        <tr>
            ...
            <td>
                ...
                <a style="margin-left: 10px;" href="<?=$base_url;?>admin/estates/deletePhotoDefault/<?php echo $object->id;?>/true" title="Xóa hình ảnh đại diện" onclick='return confirm ("Bạn có muốn xóa hình đại diện này không ?")'>Xóa hình ảnh đại diện</a>
            </td>
        </tr>
        <?php endif; ?>
        <tr>
        ...
        <tr>
            <td>&nbsp;</td>
            <td><label for="name">Thông tin liên hệ</label></td>
        </tr>
        <tr>
            <td><label for="name">Tên:</label></td>
            <td><input type="text" name="name_contact" value="<?=$object->name_contact;?>" class="smallInput medium" /></td>
        </tr>
        <tr>
            <td><label for="name">Địa chỉ:</label></td>
            <td><input type="text" name="address_contact" value="<?=$object->address_contact;?>" class="smallInput medium" /></td>
        </tr>
        <tr>
            <td><label for="name">Điện thoại cố định:</label></td>
            <td><input type="text" name="phone_contact" value="<?=$object->phone_contact;?>" class="smallInput medium" /></td>
        </tr>
        <tr>
            <td><label for="name">Địện thoại di động:</label></td>
            <td><input type="text" name="mobile_contact" value="<?=$object->mobile_contact;?>" class="smallInput medium" /></td>
        </tr>
        <tr>
            <td><label for="name">Email:</label></td>
            <td><input type="text" name="email_contact" value="<?=$object->email_contact;?>" class="smallInput medium" /></td>
        </tr>
        <tr>
            <td colspan="2">
